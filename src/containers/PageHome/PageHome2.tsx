          ...
          data={[
            {
              ...
              img: HIW2img,
              imgDark: HIW2imgDark,
              title: "Seguro para propietarios, arrendadores y arrendatarios",
              desc: "Tomamos las medidas de protección necesarias para asegurar una correcta operación.",
            },
            {
              id: 2,
              img: HIW3img,
              imgDark: HIW3imgDark,
              title: "Vende con la tasa más baja de Colombia",
              desc: "Aplicamos un 2.5% sobre el monto de la venta para cualquier inmueble en territorio Colombiano.",
            },
            {
              id: 3,
              img: HIW1img,
              imgDark: HIW1imgDark,
              title: "Renta espacios para  arriendo por horas, días, meses o años.",
              desc: "Encuentra una gran variedad de espacios que podrás arrendar desde 3 horas en adelante.",
            },
          ]}
        />
