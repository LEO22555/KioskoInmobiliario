...
const SiteHeader = () => {
                  ...
                  <Popover.Panel className="absolute right-0 z-10 mt-3 w-screen max-w-sm">
                    <div className="rounded-2xl bg-white dark:bg-neutral-800 overflow-hidden nc-custom-shadow-1">
                      <div className="relative p-6">
                        <span className="text-xl font-semibold">Necesitas ayuda, tienes dudas y/o consultas </span>
                      ...
                      <div className="bg-gray-50 dark:bg-white/5 p-5">
                        <a
                          ...
                          href={
                            "https://api.whatsapp.com/send?phone=573024236366&text=Gracias%20por%20comunicarte%20con%20Kiosko%20Inmobiliario.%20Por%20favor%2C%20haznos%20saber%20c%C3%B3mo%20podemos%20ayudarle%20%F0%9F%98%80%F0%9F%91%8D%F0%9F%8F%AC%F0%9F%8F%A0%F0%9F%8F%A1%F0%9F%8F%98%EF%B8%8F"
                          }
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <FaWhatsapp className="w-4 h-4" />
                          <span className="ml-2">Soporte via WhatsApp</span>
                        </a>
                      </div>
                    </div>
                  </Popover.Panel>
  ...
  return (
    <>
      <Helmet>
        <title>Kiosko Inmobiliario || Arrienda y Vende apartamentos, casas y oficinas fácilmente</title>
      </Helmet>
